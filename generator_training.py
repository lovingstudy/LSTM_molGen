...
finetune = True
data,vocabs=load_data(dataset_file='data/brd4_good_smiles_data.npz')

if finetune:
    d_,vocabs = load_data(dataset_file='data/chembl_smiles-1.npz')
vocabs = list(vocabs)
...
model.load_state_dict(torch.load('chembl23_training_E5000.pt'))
...
for batch in range(1,n_batches+1):
    ...
    if batch %save_every ==0:
        torch.save(model.state_dict(), 'chembl23_training_E5000_brd4FineTune_E200.pt')

with open('loss_plot_finetune.txt', 'w') as f:
